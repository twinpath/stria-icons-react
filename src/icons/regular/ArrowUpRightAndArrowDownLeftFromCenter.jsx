...
const ArrowUpRightAndArrowDownLeftFromCenterRegular = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
...
export default ArrowUpRightAndArrowDownLeftFromCenterRegular;
