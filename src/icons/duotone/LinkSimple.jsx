...
const LinkSimpleDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M192 256C192 273.672 206.312 288 224 288H416C433.688 288 448 273.672 448 256S433.688 224 416 224H224C206.312 224 192 238.328 192 256Z" className="stria-secondary" style={{ opacity: 0.4 }} />
