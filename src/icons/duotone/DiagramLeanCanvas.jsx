...
const DiagramLeanCanvasDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M64 320H128V96H64V320ZM512 96V320H576V96H512Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default DiagramLeanCanvasDuotone;
