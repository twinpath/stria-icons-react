...
const WindowFrameOpenDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M240 224.001H96V64.001H240V224.001ZM416 224.001H272V64.001H416V224.001Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default WindowFrameOpenDuotone;
