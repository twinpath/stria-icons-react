...
const LightSwitchOnDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M240 96H144C117.6 96 96 117.6 96 144V256H288V144C288 117.6 266.4 96 240 96Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default LightSwitchOnDuotone;
