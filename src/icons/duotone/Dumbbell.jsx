...
const DumbbellDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M0 256C0 273.672 14.328 288 32 288V224C14.328 224 0 238.326 0 256ZM128 288H160V224H128V288ZM608 224V288C625.672 288 640 273.672 640 256C640 238.326 625.672 224 608 224ZM480 288H512V224H480V288ZM256 288H384V224H256V288Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default DumbbellDuotone;
