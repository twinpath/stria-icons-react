...
const CameraSecurityDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M224 112C170.965 112 128 154.963 128 208C128 261.035 170.965 304 224 304S320 261.035 320 208C320 154.963 277.035 112 224 112Z" className="stria-secondary" style={{ opacity: 0.4 }} />
