...
const BrushDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M384 32V288H0V32C0 14.375 14.375 0 32 0H64L96 64L128 0H160L192 64L224 0H352C369.625 0 384 14.375 384 32Z" className="stria-secondary" style={{ opacity: 0.4 }} />
