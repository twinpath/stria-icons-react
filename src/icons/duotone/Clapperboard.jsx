...
const ClapperboardDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M512 160V416C512 451.346 483.346 480 448 480H64C28.654 480 0 451.346 0 416V160H512Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default ClapperboardDuotone;
