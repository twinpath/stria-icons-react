...
const HourglassEmptyDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
  ...
  >
    ...
    <path d="M32 64H352C369.674 64 384 49.672 384 32C384 14.326 369.674 0 352 0H32C14.326 0 0 14.326 0 32C0 49.672 14.326 64 32 64ZM352 448H32C14.326 448 0 462.326 0 480C0 497.672 14.326 512 32 512H352C369.674 512 384 497.672 384 480C384 462.326 369.674 448 352 448Z" />
  </svg>
));

HourglassEmptyDuotone.displayName = 'HourglassEmptyDuotone';

export default HourglassEmptyDuotone;
