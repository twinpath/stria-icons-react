...
const WalletDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M480 80V136.877C470.555 131.379 459.717 128 448 128H48C21.49 128 0 106.51 0 80S21.49 32 48 32H432C458.51 32 480 53.492 480 80Z" className="stria-secondary" style={{ opacity: 0.4 }} />
