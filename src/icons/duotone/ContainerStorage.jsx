...
const ContainerStorageDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M48 96V416H592V96H48ZM112 368V144H144V368H112ZM208 368V144H240V368H208ZM304 368V144H336V368H304ZM400 368V144H432V368H400ZM496 368V144H528V368H496Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default ContainerStorageDuotone;
