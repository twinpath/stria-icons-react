...
const LightSwitchDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M288 272H96V240H288V272Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default LightSwitchDuotone;
