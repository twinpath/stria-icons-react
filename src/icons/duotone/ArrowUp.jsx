...
const ArrowUpDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M224 127.188L264 165.18V440C264 462.094 246.094 480 224 480S184 462.094 184 440V165.18L224 127.188Z" className="stria-secondary" style={{ opacity: 0.4 }} />
