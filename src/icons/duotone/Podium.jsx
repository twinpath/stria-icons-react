...
const PodiumDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M400 192L370.882 483.184C369.246 499.543 355.48 512 339.04 512H108.96C92.52 512 78.754 499.543 77.118 483.184L48 192H400Z" className="stria-secondary" style={{ opacity: 0.4 }} />
