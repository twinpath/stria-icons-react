...
const MapDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M192 416L384 480V96L192 32V416Z" className="stria-secondary" style={{ opacity: 0.4 }} />
