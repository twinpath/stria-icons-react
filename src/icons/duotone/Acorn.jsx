...
const AcornDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M400 192.001V224.001C400 397.875 271.047 457.133 224 480C176.953 457.133 48 397.875 48 224.001V192.001H400Z" className="stria-secondary" style={{ opacity: 0.4 }} />
