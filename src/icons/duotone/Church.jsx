...
const ChurchDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M0 396V480C0 497.672 14.328 512 32 512H160V306.254L19.375 366.5C7.625 371.625 0 383.125 0 396ZM620.625 366.5L480 306.254V512H608C625.674 512 640 497.672 640 480V396C640 383.125 632.375 371.625 620.625 366.5Z" className="stria-secondary" style={{ opacity: 0.4 }} />
