...
const MusicDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M192 224V83.691L448 8.092V148.994L192 224Z" className="stria-secondary" style={{ opacity: 0.4 }} />
