...
const DaggerDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M128 428.875L178.75 504.875C185 514.375 199 514.375 205.375 504.875L256 428.875V192H128V428.875Z" className="stria-secondary" style={{ opacity: 0.4 }} />
