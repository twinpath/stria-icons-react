...
const CricketBatBallDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M191.999 166.966L9.592 349.365C3.731 355.227 0 363.166 0 371.382C0 474.17 108.873 511.982 140.599 511.982C148.816 511.982 156.758 508.251 162.624 502.387L345.023 319.991H191.999V166.966Z " className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default CricketBatBallDuotone;
