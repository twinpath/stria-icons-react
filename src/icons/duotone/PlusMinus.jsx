...
const PlusMinusDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M344 512H40C17.906 512 0 494.094 0 472S17.906 432 40 432H344C366.094 432 384 449.906 384 472S366.094 512 344 512Z" className="stria-secondary" style={{ opacity: 0.4 }} />
