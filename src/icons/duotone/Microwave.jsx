...
const MicrowaveDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M416 352H96V128H416V352Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default MicrowaveDuotone;
