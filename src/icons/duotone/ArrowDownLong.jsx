...
const ArrowDownLongDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M160 434.75L128 402.75V32C128 14.312 142.312 0 160 0S192 14.312 192 32V402.75L160 434.75Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default ArrowDownLongDuotone;
