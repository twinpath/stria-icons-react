...
const ScytheDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M583.873 0H338.852C191.986 0 63.996 64 0 192H544L583.873 0Z" className="stria-secondary" style={{ opacity: 0.4 }} />
