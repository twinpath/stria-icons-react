...
const MortarPestleDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M402.375 160H251L454.75 7.125C465.625 -1 480 -2.25 492.125 3.75C513.875 14.625 518.625 43.75 501.375 60.875L402.375 160Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default MortarPestleDuotone;
