...
const WindowFrameDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M272 64V224H416V64H272ZM96 224H240V64H96V224ZM96 448H240V288H96V448ZM272 448H416V288H272V448Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default WindowFrameDuotone;
