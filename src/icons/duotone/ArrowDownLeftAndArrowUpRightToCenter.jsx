...
const ArrowDownLeftAndArrowUpRightToCenterDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
...
export default ArrowDownLeftAndArrowUpRightToCenterDuotone;
