...
const PresentationScreenDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M512 352.04H64C46.375 352.04 32 337.663 32 320.036V64.007H96V288.032H480V64.007H544V320.036C544 337.663 529.625 352.04 512 352.04Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default PresentationScreenDuotone;
