...
const BookmarkSlashDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M128 512L358.564 377.713L128 197.002V512ZM464 0H176C149.5 0 128 21.5 128 48V75.012L512 375.98V48C512 21.5 490.5 0 464 0Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default BookmarkSlashDuotone;
