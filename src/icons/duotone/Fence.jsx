...
const FenceDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M128 224H224V160H128V224ZM128 416H224V352H128V416ZM352 416H448V352H352V416ZM352 160V224H448V160H352Z" className="stria-secondary" style={{ opacity: 0.4 }} />
