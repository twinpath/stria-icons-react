...
const LayersMinusDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M499.625 236.25L266.625 130.75C259.875 127.625 252.125 127.625 245.375 130.75L12.375 236.25C-4.125 243.75 -4.125 268.75 12.375 276.25L245.375 381.875C252.125 385 259.875 385 266.625 381.875L499.625 276.25C516.125 268.75 516.125 243.75 499.625 236.25Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default LayersMinusDuotone;
