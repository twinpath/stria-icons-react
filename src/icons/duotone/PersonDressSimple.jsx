...
const PersonDressSimpleDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M128 128C163.375 128 192 99.375 192 64S163.375 0 128 0S64 28.625 64 64S92.625 128 128 128Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default PersonDressSimpleDuotone;
