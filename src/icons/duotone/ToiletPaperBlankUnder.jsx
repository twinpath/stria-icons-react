...
const ToiletPaperBlankUnderDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M416 384H96C43 384 0 298 0 192C0 86 43 0 96 0H416C363 0 320 86 320 192C320 298 363 384 416 384Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default ToiletPaperBlankUnderDuotone;
