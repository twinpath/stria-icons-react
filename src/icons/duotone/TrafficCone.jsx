...
const TrafficConeDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M400.125 288H111.375L86 352H425.5L400.125 288ZM336.375 128H175.125L149.625 192H361.875L336.375 128Z" className="stria-secondary" style={{ opacity: 0.4 }} />
