...
const ArrowDownDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M184 346.82V72C184 49.906 201.906 32 224 32S264 49.906 264 72V346.82L224 384.812L184 346.82Z" className="stria-secondary" style={{ opacity: 0.4 }} />
