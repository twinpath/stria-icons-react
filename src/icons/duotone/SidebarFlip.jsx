...
const SidebarFlipDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M64 32H288V480H64C28.654 480 0 451.346 0 416V96C0 60.652 28.654 32 64 32Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default SidebarFlipDuotone;
