...
const TruckRampDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M640 416C640 469.02 597.02 512 544 512S448 469.02 448 416S490.98 320 544 320S640 362.98 640 416Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default TruckRampDuotone;
