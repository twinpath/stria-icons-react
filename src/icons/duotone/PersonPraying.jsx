...
const PersonPrayingDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M256 128C291.375 128 320 99.375 320 64S291.375 0 256 0S192 28.625 192 64S220.625 128 256 128Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default PersonPrayingDuotone;
