...
const UpLongDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M120 159.999H200V471.987C200 494.087 182.094 511.999 160 511.999S120 494.087 120 471.987V159.999Z" className="stria-secondary" style={{ opacity: 0.4 }} />
