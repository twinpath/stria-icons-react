...
const VectorSquareDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M32 352H96V160H32V352ZM352 160V352H416V160H352ZM128 448H320V384H128V448ZM128 128H320V64H128V128Z" className="stria-secondary" style={{ opacity: 0.4 }} />
