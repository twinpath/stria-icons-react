...
const DiagramNestedDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M288 432H176C123.062 432 80 388.938 80 336V224H144V336C144 353.656 158.344 368 176 368H288V432Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default DiagramNestedDuotone;
