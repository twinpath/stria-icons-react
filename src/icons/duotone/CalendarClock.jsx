...
const CalendarClockDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M448 192H432C437.402 192 442.723 192.33 448 192.807V192ZM256 368C256 270.799 334.799 192 432 192H0V464C0 490.5 21.5 512 48 512H331.002C285.691 480.158 256 427.586 256 368Z" className="stria-secondary" style={{ opacity: 0.4 }} />
