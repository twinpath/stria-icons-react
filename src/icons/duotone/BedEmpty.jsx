...
const BedEmptyDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M544 224H64V320H640C640 266.981 597.019 224 544 224Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default BedEmptyDuotone;
