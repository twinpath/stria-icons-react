...
const BarsDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M448 256V256C448 273.673 433.673 288 416 288H32C14.327 288 0 273.673 0 256V256C0 238.327 14.327 224 32 224H416C433.673 224 448 238.327 448 256Z" className="stria-secondary" style={{ opacity: 0.4 }} />
