...
const ArrowTurnUpDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M232 132.047V472C232 494.094 214.094 512 192 512H40C17.906 512 0 494.094 0 472S17.906 432 40 432H152V132.055L192.002 94.711L232 132.047Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default ArrowTurnUpDuotone;
