...
const FolderTreeDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M64 16C64 7.125 56.875 0 48 0H16C7.125 0 0 7.125 0 16V416C0 433.625 14.375 448 32 448H256V384H64V160H256V96H64V16Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default FolderTreeDuotone;
