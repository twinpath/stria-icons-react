...
const TurnDownDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M152 352V80H40C17.906 80 0 62.094 0 40S17.906 0 40 0H192C214.094 0 232 17.906 232 40V352H152Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default TurnDownDuotone;
