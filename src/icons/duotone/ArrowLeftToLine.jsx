...
const ArrowLeftToLineDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M32 64C14.312 64 0 78.312 0 96V416C0 433.688 14.312 448 32 448S64 433.688 64 416V96C64 78.312 49.688 64 32 64Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default ArrowLeftToLineDuotone;
