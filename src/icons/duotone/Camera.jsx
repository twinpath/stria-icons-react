...
const CameraDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M256 384C203 384 160 341 160 288S203 192 256 192S352 235 352 288S309 384 256 384Z" className="stria-secondary" style={{ opacity: 0.4 }} />
