...
const ChildDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M224 144C263.751 144 296.001 111.75 296.001 72S263.751 0 224 0S152 32.25 152 72S184.25 144 224 144Z" className="stria-secondary" style={{ opacity: 0.4 }} />
