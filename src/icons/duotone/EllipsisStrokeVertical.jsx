...
const EllipsisStrokeVerticalDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M96 176C51.834 176 16 211.834 16 256S51.834 336 96 336S176 300.166 176 256S140.166 176 96 176ZM96 272C87.178 272 80 264.822 80 256S87.178 240 96 240S112 247.178 112 256S104.822 272 96 272Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default EllipsisStrokeVerticalDuotone;
