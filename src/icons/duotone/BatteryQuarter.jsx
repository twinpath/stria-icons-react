...
const BatteryQuarterDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
  ...
  >
    ...
    <path d="M192 192H96V320H192V192Z" />
  </svg>
));

BatteryQuarterDuotone.displayName = 'BatteryQuarterDuotone';

export default BatteryQuarterDuotone;
