...
const BatDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M411.295 172.332L320.15 224L229 172.361L256.15 64L298.775 96H341.525L384.15 64L411.295 172.332Z" className="stria-secondary" style={{ opacity: 0.4 }} />
