...
const InboxInDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M480 320H384L352 384H160L128 320H32C14.326 320 0 334.328 0 352V464C0 490.508 21.49 512 48 512H464C490.51 512 512 490.508 512 464V352C512 334.328 497.674 320 480 320Z" className="stria-secondary" style={{ opacity: 0.4 }} />
