...
const WarehouseDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M511.75 352H128V416H511.5L511.75 352ZM128 512H512V448H128.125L128 512ZM512 256H128V320H511.834L512 256Z" className="stria-secondary" style={{ opacity: 0.4 }} />
