...
const DownDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M128 256V64C128 46.326 142.328 32 160 32H224C241.674 32 256 46.326 256 64V256H128Z" className="stria-secondary" style={{ opacity: 0.4 }} />
