...
const TemperatureHalfDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
  ...
  >
    ...
    <path d="M176 322.876V208.001C176 199.251 168.75 192.001 160 192.001S144 199.251 144 208.001V322.876C125.375 329.501 112 347.126 112 368.001C112 394.501 133.5 416.001 160 416.001S208 394.501 208 368.001C208 347.126 194.625 329.501 176 322.876Z" />
  </svg>
));

TemperatureHalfDuotone.displayName = 'TemperatureHalfDuotone';

export default TemperatureHalfDuotone;
