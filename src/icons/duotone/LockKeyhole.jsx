...
const LockKeyholeDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M416 144V224H352V144C352 99.875 316.109 64 272 64S192 99.875 192 144V224H128V144C128 64.594 192.594 0 272 0S416 64.594 416 144Z" className="stria-secondary" style={{ opacity: 0.4 }} />
