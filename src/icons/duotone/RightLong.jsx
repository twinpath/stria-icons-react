...
const RightLongDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M352 216V296H40.012C17.912 296 0 278.094 0 256S17.912 216 40.012 216H352Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default RightLongDuotone;
