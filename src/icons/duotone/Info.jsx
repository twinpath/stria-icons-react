...
const InfoDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M160 80C160 115.346 131.346 144 96 144S32 115.346 32 80C32 44.652 60.654 16 96 16S160 44.652 160 80Z" className="stria-secondary" style={{ opacity: 0.4 }} />
