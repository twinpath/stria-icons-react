...
const LightSwitchOffDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M144 416H240C266.4 416 288 394.4 288 368V256H96V368C96 394.4 117.6 416 144 416Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default LightSwitchOffDuotone;
