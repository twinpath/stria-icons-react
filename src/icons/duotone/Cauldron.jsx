...
const CauldronDuotone = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
    ...
    {...props}
  >
    <path d="M160 0C142.375 0 128 14.375 128 32S142.375 64 160 64S192 49.625 192 32S177.625 0 160 0ZM272 32C245.5 32 224 53.5 224 80S245.5 128 272 128S320 106.5 320 80S298.5 32 272 32ZM96 288C96 305.672 110.326 320 128 320S160 305.672 160 288V160H96V288Z" className="stria-secondary" style={{ opacity: 0.4 }} />
...
export default CauldronDuotone;
