...
const HackerNewsSquareBrands = forwardRef(({ size = 24, color = 'currentColor', className, ...props }, ref) => (
  <svg
    ref={ref}
...
HackerNewsSquareBrands.displayName = 'HackerNewsSquareBrands';

export default HackerNewsSquareBrands;
