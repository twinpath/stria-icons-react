...
const StoreSlashLight = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
  "svg",
  {
    ref,
...
StoreSlashLight.displayName = "StoreSlashLight";
var StoreSlash_default = StoreSlashLight;
