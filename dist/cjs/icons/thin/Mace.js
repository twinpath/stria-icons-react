...
const MaceThin = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
  "svg",
  {
    ref,
...
MaceThin.displayName = "MaceThin";
var Mace_default = MaceThin;
