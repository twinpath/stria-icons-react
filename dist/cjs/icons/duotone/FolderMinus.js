...
const FolderMinusDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M360 288C360 301.258 349.262 311.998 336.002 311.998H175.998C162.73 311.998 152 301.256 152 288C152 274.742 162.738 264.002 175.998 264.002H336.002C349.262 264.002 360 274.742 360 288Z" })
    ]
  }
));
