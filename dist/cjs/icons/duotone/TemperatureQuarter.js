...
const TemperatureQuarterDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M176 322.876V272.001C176 263.251 168.75 256.001 160 256.001S144 263.251 144 272.001V322.876C125.375 329.501 112 347.126 112 368.001C112 394.501 133.5 416.001 160 416.001S208 394.501 208 368.001C208 347.126 194.625 329.501 176 322.876Z" })
    ]
  }
));
TemperatureQuarterDuotone.displayName = "TemperatureQuarterDuotone";
var TemperatureQuarter_default = TemperatureQuarterDuotone;
