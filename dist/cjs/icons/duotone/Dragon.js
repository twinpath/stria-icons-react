...
const DragonDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M5.785 227.625L123.269 111.25C145.018 92.75 176.514 90.875 200.26 106.75L351.992 217.76V236.625C351.992 265.711 358.125 293.924 369.082 320H112.021C97.773 320 90.65 302.75 100.773 292.625L192.012 224L18.408 255.75C2.41 258.001 -6.588 238 5.785 227.625Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
DragonDuotone.displayName = "DragonDuotone";
var Dragon_default = DragonDuotone;
