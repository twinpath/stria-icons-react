...
const MoneyBillSimpleWaveDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M288 352C243.816 352 208 309.018 208 256C208 202.98 243.816 160 288 160S368 202.98 368 256C368 309.018 332.184 352 288 352Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
MoneyBillSimpleWaveDuotone.displayName = "MoneyBillSimpleWaveDuotone";
var MoneyBillSimpleWave_default = MoneyBillSimpleWaveDuotone;
