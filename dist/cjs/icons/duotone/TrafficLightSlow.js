...
const TrafficLightSlowDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M192 288.001C165.5 288.001 144 266.501 144 240.001S165.5 192.001 192 192.001S240 213.501 240 240.001S218.5 288.001 192 288.001Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
TrafficLightSlowDuotone.displayName = "TrafficLightSlowDuotone";
var TrafficLightSlow_default = TrafficLightSlowDuotone;
