...
const GaugeMaxDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M484 375.626L349.999 398.001C348.5 404.376 346.375 410.501 343.125 416.001H232.875C227.375 406.501 224 395.751 224 384.001C224 348.626 252.625 320.001 288 320.001C311 320.001 331.125 332.251 342.375 350.626L476 328.376C489.125 326.126 501.5 335.001 503.625 348.001C505.875 361.126 497 373.501 484 375.626Z" })
    ]
  }
));
GaugeMaxDuotone.displayName = "GaugeMaxDuotone";
var GaugeMax_default = GaugeMaxDuotone;
