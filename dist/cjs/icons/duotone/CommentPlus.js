...
const CommentPlusDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M360 240C360 253.258 349.262 263.998 336.002 263.998H279.998V320.002C279.998 333.262 269.258 344 256 344C242.734 344 232.002 333.258 232.002 320.002V263.998H175.998C162.73 263.998 152 253.256 152 240C152 226.742 162.738 216.002 175.998 216.002H232.002V159.998C232.002 146.738 242.742 136 256 136S279.998 146.738 279.998 159.998V216.002H336.002C349.262 216.002 360 226.742 360 240Z" })
    ]
  }
));
CommentPlusDuotone.displayName = "CommentPlusDuotone";
var CommentPlus_default = CommentPlusDuotone;
