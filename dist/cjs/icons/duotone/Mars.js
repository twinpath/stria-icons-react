...
const MarsDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M240 304C240 339.346 211.346 368 176 368S112 339.346 112 304S140.654 240 176 240S240 268.654 240 304Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
MarsDuotone.displayName = "MarsDuotone";
var Mars_default = MarsDuotone;
