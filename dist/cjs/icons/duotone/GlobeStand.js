...
const GlobeStandDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M208 352C299.394 352 368 277.268 368 192C368 106.734 299.347 32 208 32C116.606 32 48 106.733 48 192C48 277.266 116.653 352 208 352Z ", className: "stria-secondary", style: { opacity: 0.4 } }),
...
var GlobeStand_default = GlobeStandDuotone;
