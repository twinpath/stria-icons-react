...
var Square0_exports = {};
__export(Square0_exports, {
  default: () => Square0_default
});
module.exports = __toCommonJS(Square0_exports);
var import_jsx_runtime = require("react/jsx-runtime");
var import_react = __toESM(require("react"), 1);
const Square0Duotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M224 128C171.062 128 128 171.062 128 224V288C128 340.938 171.062 384 224 384S320 340.938 320 288V224C320 171.062 276.938 128 224 128ZM272 288C272 314.469 250.469 336 224 336S176 314.469 176 288V224C176 197.531 197.531 176 224 176S272 197.531 272 224V288Z" })
    ]
  }
));
