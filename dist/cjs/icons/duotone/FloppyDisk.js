...
const FloppyDiskDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M288 352C288 387.344 259.344 416 224 416S160 387.344 160 352S188.656 288 224 288S288 316.656 288 352Z" })
    ]
  }
));
FloppyDiskDuotone.displayName = "FloppyDiskDuotone";
var FloppyDisk_default = FloppyDiskDuotone;
