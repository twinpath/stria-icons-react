...
const EngineDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M505.999 211.5L434.723 154.498C426.223 147.703 415.664 144 404.781 144H128C101.49 144 80 165.49 80 192V336C80 362.51 101.49 384 128 384H169.375L219.32 433.945C228.32 442.943 240.523 448 253.25 448H464C490.51 448 512 426.51 512 400V223.98C512 219.125 509.793 214.531 505.999 211.5ZM192 280C178.746 280 168 269.254 168 256C168 242.744 178.746 232 192 232S216 242.744 216 256C216 269.254 205.254 280 192 280ZM288 280C274.746 280 264 269.254 264 256C264 242.744 274.746 232 288 232S312 242.744 312 256C312 269.254 301.254 280 288 280ZM384 280C370.746 280 360 269.254 360 256C360 242.744 370.746 232 384 232S408 242.744 408 256C408 269.254 397.254 280 384 280Z" })
    ]
  }
));
EngineDuotone.displayName = "EngineDuotone";
var Engine_default = EngineDuotone;
