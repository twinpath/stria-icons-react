...
const InputPipeDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M128 352C141.254 352 152 341.254 152 328V184C152 170.744 141.254 160 128 160S104 170.744 104 184V328C104 341.254 114.746 352 128 352Z" })
    ]
  }
));
