...
const TrafficLightGoDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M192 416.001C165.5 416.001 144 394.501 144 368.001S165.5 320.001 192 320.001S240 341.501 240 368.001S218.5 416.001 192 416.001Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
TrafficLightGoDuotone.displayName = "TrafficLightGoDuotone";
var TrafficLightGo_default = TrafficLightGoDuotone;
