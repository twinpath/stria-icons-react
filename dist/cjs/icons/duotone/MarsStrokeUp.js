...
const MarsStrokeUpDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M256 335.999C256 371.345 227.346 399.999 192 399.999S128 371.345 128 335.999S156.654 272 192 272S256 300.653 256 335.999Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
MarsStrokeUpDuotone.displayName = "MarsStrokeUpDuotone";
var MarsStrokeUp_default = MarsStrokeUpDuotone;
