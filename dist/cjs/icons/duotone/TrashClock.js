...
const TrashClockDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M331.002 512H101.094C76.219 512 54.75 491.844 53.188 467L32 96H416L410.434 193.453C323.428 204.105 256 278.113 256 368C256 427.586 285.691 480.158 331.002 512Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
TrashClockDuotone.displayName = "TrashClockDuotone";
var TrashClock_default = TrashClockDuotone;
