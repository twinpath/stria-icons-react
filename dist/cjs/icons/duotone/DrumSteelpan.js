...
const DrumSteelpanDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M172 90C98.125 103.625 48 129.875 48 160C48 190.75 100.25 217.5 176.75 230.875C190.5 220.875 200.5 207 205 190.375C210.125 171.25 207.5 151.375 197.625 134.25L172 90ZM288 192C259.25 192 235.125 211.125 227.125 237.25C246.625 239 266.875 240 288 240S329.375 239 348.875 237.25C340.875 211.125 316.75 192 288 192ZM224 83V96C224 131.25 252.75 160 288 160S352 131.25 352 96V83C331.625 81.125 310.25 80 288 80S244.375 81.125 224 83ZM403.5 89.875L377.875 134.375C368 151.375 365.375 171.25 370.5 190.375C375 207 385.125 221 398.875 230.875C475.625 217.5 528 190.875 528 160C528 129.75 477.75 103.5 403.5 89.875Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
DrumSteelpanDuotone.displayName = "DrumSteelpanDuotone";
var DrumSteelpan_default = DrumSteelpanDuotone;
