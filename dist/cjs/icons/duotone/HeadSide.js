...
const HeadSideDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M351.998 224C334.374 224 320 209.625 320 192S334.374 160 351.998 160S383.996 174.375 383.996 192S369.622 224 351.998 224Z" })
    ]
  }
));
