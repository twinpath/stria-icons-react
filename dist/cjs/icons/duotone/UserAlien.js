...
const UserAlienDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M148 176H124C117.375 176 112 181.375 112 188V196C112 229.125 138.875 256 172 256H196C202.625 256 208 250.625 208 244V236C208 202.875 181.125 176 148 176ZM324 176H300C266.875 176 240 202.875 240 236V244C240 250.625 245.375 256 252 256H276C309.125 256 336 229.125 336 196V188C336 181.375 330.625 176 324 176Z" })
    ]
  }
));
UserAlienDuotone.displayName = "UserAlienDuotone";
var UserAlien_default = UserAlienDuotone;
