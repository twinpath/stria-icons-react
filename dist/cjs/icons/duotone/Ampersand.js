...
const AmpersandDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M270 300.268L310.49 241.475C322.926 223.242 347.768 218.492 366.08 230.959C384.328 243.396 389.045 268.285 376.609 286.535L325.447 360.914L270 300.268Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
AmpersandDuotone.displayName = "AmpersandDuotone";
var Ampersand_default = AmpersandDuotone;
