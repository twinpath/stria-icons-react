...
const FaceGrimaceDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M175.939 176C158.275 176 144 190.25 144 208S158.275 240 175.939 240C193.725 240 208 225.75 208 208S193.725 176 175.939 176ZM336.061 176C318.275 176 304 190.25 304 208S318.275 240 336.061 240C353.725 240 368 225.75 368 208S353.725 176 336.061 176Z" })
    ]
  }
));
FaceGrimaceDuotone.displayName = "FaceGrimaceDuotone";
var FaceGrimace_default = FaceGrimaceDuotone;
