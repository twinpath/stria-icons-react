...
const UserPilotDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M346.002 155.496C349.512 167.133 352 179.207 352 192C352 262.75 294.75 320 224 320S96 262.75 96 192C96 179.207 98.488 167.133 101.998 155.496C137.928 168.297 179.334 176 224 176S310.072 168.297 346.002 155.496Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
UserPilotDuotone.displayName = "UserPilotDuotone";
var UserPilot_default = UserPilotDuotone;
