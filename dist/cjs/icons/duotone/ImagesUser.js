...
const ImagesUserDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M240.014 320H432.014C440.85 320 448.014 312.836 448.014 304C448.014 277.492 426.523 256 400.014 256H272.014C245.504 256 224.014 277.492 224.014 304C224.014 312.836 231.178 320 240.014 320ZM336.014 224C371.359 224 400.014 195.344 400.014 160S371.359 96 336.014 96S272.014 124.656 272.014 160S300.668 224 336.014 224ZM80 432C62.326 432 48 417.672 48 400V96C21.49 96 0 117.492 0 144V416C0 451.344 28.654 480 64 480H432C458.51 480 480 458.508 480 432H80Z" })
    ]
  }
));
ImagesUserDuotone.displayName = "ImagesUserDuotone";
var ImagesUser_default = ImagesUserDuotone;
