...
const PlayPauseDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M52.508 71.406C31.879 54.283 0 68.656 0 96.027V415.973C0 443.344 31.879 457.715 52.508 440.594L244.531 280.621C259.781 267.748 259.781 244.252 244.531 231.379L52.508 71.406Z" })
    ]
  }
));
