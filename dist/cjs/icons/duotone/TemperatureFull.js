...
const TemperatureFullDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M176 322.876V112.001C176 103.251 168.75 96.001 160 96.001S144 103.251 144 112.001V322.876C125.375 329.501 112 347.126 112 368.001C112 394.501 133.5 416.001 160 416.001S208 394.501 208 368.001C208 347.126 194.625 329.501 176 322.876Z" })
    ]
  }
));
TemperatureFullDuotone.displayName = "TemperatureFullDuotone";
var TemperatureFull_default = TemperatureFullDuotone;
