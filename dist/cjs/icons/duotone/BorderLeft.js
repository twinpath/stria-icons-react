...
const BorderLeftDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M64 64V448C64 465.673 49.673 480 32 480H32C14.327 480 0 465.673 0 448V64C0 46.327 14.327 32 32 32H32C49.673 32 64 46.327 64 64Z" })
    ]
  }
));
BorderLeftDuotone.displayName = "BorderLeftDuotone";
var BorderLeft_default = BorderLeftDuotone;
