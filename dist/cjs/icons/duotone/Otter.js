...
const OtterDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M638.016 112C630.363 157.363 591.165 192 543.628 192H520.752L428.251 241.75L393 171.25L511.627 112H638.016Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
OtterDuotone.displayName = "OtterDuotone";
var Otter_default = OtterDuotone;
