...
const BorderBottomDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M448 448V448C448 465.673 433.673 480 416 480H32C14.327 480 0 465.673 0 448V448C0 430.327 14.327 416 32 416H416C433.673 416 448 430.327 448 448Z" })
    ]
  }
));
BorderBottomDuotone.displayName = "BorderBottomDuotone";
var BorderBottom_default = BorderBottomDuotone;
