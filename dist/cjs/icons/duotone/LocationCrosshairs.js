...
const LocationCrosshairsDuotone = (0, import_react.forwardRef)(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M256 168C207.375 168 168 207.375 168 256S207.375 344 256 344S344 304.625 344 256S304.625 168 256 168Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
LocationCrosshairsDuotone.displayName = "LocationCrosshairsDuotone";
var LocationCrosshairs_default = LocationCrosshairsDuotone;
