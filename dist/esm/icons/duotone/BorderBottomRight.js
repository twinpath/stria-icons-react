...
const BorderBottomRightDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M448 64V416C448 451.2 419.2 480 384 480H32C14.327 480 0 465.673 0 448V448C0 430.327 14.327 416 32 416H384V64C384 46.327 398.327 32 416 32H416C433.673 32 448 46.327 448 64Z" })
    ]
  }
));
...
export {
  BorderBottomRight_default as default
};
