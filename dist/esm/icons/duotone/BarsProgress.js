...
const BarsProgressDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M24 320H160V192H24C10.75 192 0 202.75 0 216V296C0 309.25 10.75 320 24 320ZM0 376V456C0 469.25 10.75 480 24 480H288V352H24C10.75 352 0 362.75 0 376ZM24 32C10.75 32 0 42.75 0 56V136C0 149.25 10.75 160 24 160H352V32H24Z" })
    ]
  }
));
