...
const StrikethroughDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M512 264C512 277.25 501.25 288 488 288H24C10.75 288 0 277.25 0 264S10.75 240 24 240H488C501.25 240 512 250.75 512 264Z" })
    ]
  }
));
