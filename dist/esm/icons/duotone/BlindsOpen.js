...
const BlindsOpenDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M512 16V48C512 56.836 504.836 64 496 64H128V210.938C146.6 217.549 160 235.131 160 256C160 282.51 138.51 304 112 304S64 282.51 64 256C64 235.131 77.4 217.549 96 210.938V64H16C7.164 64 0 56.836 0 48V16C0 7.162 7.164 0 16 0H496C504.836 0 512 7.162 512 16Z" })
    ]
  }
));
