...
const SackDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M320 128H192C183.163 128 176 120.837 176 112V112C176 103.163 183.163 96 192 96H320C328.837 96 336 103.163 336 112V112C336 120.837 328.837 128 320 128Z" })
    ]
  }
));
