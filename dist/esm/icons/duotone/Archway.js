...
const ArchwayDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M560 0H16C7.125 0 0 7.125 0 16V48C0 56.875 7.125 64 16 64H560C568.875 64 576 56.875 576 48V16C576 7.125 568.875 0 560 0Z" })
    ]
  }
));
