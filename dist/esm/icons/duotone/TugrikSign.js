...
const TugrikSignDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M384 72C384 94.094 366.094 112 344 112H232V440C232 462.094 214.094 480 192 480S152 462.094 152 440V112H40C17.906 112 0 94.094 0 72S17.906 32 40 32H344C366.094 32 384 49.906 384 72Z" })
    ]
  }
));
