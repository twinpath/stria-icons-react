...
const UmbrellaBeachDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M396.34 239.172L321.004 448.001H253L336.225 217.276L396.34 239.172Z", className: "stria-secondary", style: { opacity: 0.4 } }),
