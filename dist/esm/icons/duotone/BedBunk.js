...
const BedBunkDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M64 128V16C64 7.125 56.875 0 48 0H16C7.125 0 0 7.125 0 16V496C0 504.875 7.125 512 16 512H48C56.875 512 64 504.875 64 496V448H512V496C512 504.875 519.125 512 528 512H560C568.875 512 576 504.875 576 496V128H64ZM512 384H64V192H512V384Z" })
    ]
  }
));
