...
const TrademarkDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M256 144C256 170.5 234.5 192 208 192H176V368C176 394.5 154.5 416 128 416S80 394.5 80 368V192H48C21.5 192 0 170.5 0 144S21.5 96 48 96H208C234.5 96 256 117.5 256 144Z" })
    ]
  }
));
