...
const PagerDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M448 224C448 241.625 433.625 256 416 256H96C78.375 256 64 241.625 64 224V160C64 142.375 78.375 128 96 128H416C433.625 128 448 142.375 448 160V224Z", className: "stria-secondary", style: { opacity: 0.4 } }),
