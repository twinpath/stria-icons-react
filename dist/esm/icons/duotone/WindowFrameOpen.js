...
const WindowFrameOpenDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M240 224.001H96V64.001H240V224.001ZM416 224.001H272V64.001H416V224.001Z", className: "stria-secondary", style: { opacity: 0.4 } }),
