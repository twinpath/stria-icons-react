...
const DogDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M448.001 243.627V277.502L298 224.002L320.001 197.877L448.001 243.627Z", className: "stria-secondary", style: { opacity: 0.4 } }),
