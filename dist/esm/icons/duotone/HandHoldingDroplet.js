...
const HandHoldingDropletDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M288 256C341 256 384 213.875 384 162C384 122 326.875 41.25 300.75 6.375C294.375 -2.125 281.625 -2.125 275.25 6.375C249.125 41.25 192 122 192 162C192 213.875 235 256 288 256Z" })
    ]
  }
));
...
export {
  HandHoldingDroplet_default as default
};
