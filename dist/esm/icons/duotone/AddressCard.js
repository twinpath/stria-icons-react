...
const AddressCardDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M176 256C211.346 256 240 227.346 240 192S211.346 128 176 128S112 156.654 112 192S140.654 256 176 256ZM208 288H144C99.816 288 64 323.816 64 368C64 376.836 71.164 384 80 384H272C280.836 384 288 376.836 288 368C288 323.816 252.184 288 208 288Z" })
    ]
  }
));
...
export {
  AddressCard_default as default
};
