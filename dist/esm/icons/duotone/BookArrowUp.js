...
const BookArrowUpDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M64 416C64 433.672 78.328 448 96 448H216V384H96C78.328 384 64 398.326 64 416ZM264 384V448H416V384H264Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
export {
  BookArrowUp_default as default
};
