...
const NetworkWiredDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M640 248V264C640 272.875 632.875 280 624 280H536V320H488V280H152V320H104V280H16C7.125 280 0 272.875 0 264V248C0 239.125 7.125 232 16 232H296V192H344V232H624C632.875 232 640 239.125 640 248Z", className: "stria-secondary", style: { opacity: 0.4 } }),
