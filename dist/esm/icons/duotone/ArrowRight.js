...
const ArrowRightDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M314.82 296H40C17.906 296 0 278.094 0 256S17.906 216 40 216H314.82L352.812 256L314.82 296Z", className: "stria-secondary", style: { opacity: 0.4 } }),
