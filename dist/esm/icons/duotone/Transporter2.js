...
const Transporter2Duotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M384 448H128C110 448 96 462 96 480V512H416V480C416 462 402 448 384 448ZM338 151C326 136 308 128 289 128H223C204 128 186 136 174 151L113 224H399L338 151ZM256 96C282 96 304 74 304 48S282 0 256 0S208 22 208 48S230 96 256 96Z" })
    ]
  }
));
...
export {
  Transporter2_default as default
};
