...
const UtilityPoleDoubleDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M288 128V256H512V288C512 305.672 497.674 320 480 320H288V512H224V320H32C14.328 320 0 305.672 0 288V256H224V128H32C14.326 128 0 113.672 0 96V64H224V16C224 7.162 231.164 0 240 0H272C280.836 0 288 7.162 288 16V64H512V96C512 113.672 497.674 128 480 128H288Z" })
    ]
  }
));
...
export {
  UtilityPoleDouble_default as default
};
