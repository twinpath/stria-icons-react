...
const UserGraduateDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M384 160C384 230.75 326.75 288 256 288S128 230.75 128 160H384Z", className: "stria-secondary", style: { opacity: 0.4 } }),
