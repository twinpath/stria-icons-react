...
const MapLocationDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M408.002 120C408.002 168.383 391.146 181.898 300.324 313.547C294.367 322.148 281.633 322.148 275.676 313.547C184.855 181.898 168 168.383 168 120C168 53.73 221.73 0 288 0C354.271 0 408.002 53.73 408.002 120Z" })
    ]
  }
));
...
export {
  MapLocation_default as default
};
