...
const CandleHolderDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M256 256V464H64V256C64 238.375 78.375 224 96 224H128V272C128 280.875 135.125 288 144 288S160 280.875 160 272V224H224C241.625 224 256 238.375 256 256Z" })
    ]
  }
));
