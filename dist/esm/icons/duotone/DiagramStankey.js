...
const DiagramStankeyDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M608 64V128C608 145.674 593.674 160 576 160H404.234L346.635 256H32C14.326 256 0 270.326 0 288V224C0 206.326 14.326 192 32 192H235.766L313.123 63.072C324.689 43.795 345.521 32 368.002 32H576C593.674 32 608 46.326 608 64Z" })
    ]
  }
));
