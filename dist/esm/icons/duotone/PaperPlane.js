...
const PaperPlaneDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M415.666 96.004L198.408 375.335C194.039 380.952 191.666 387.864 191.666 394.98V512L122 360.302L415.666 96.004Z" })
    ]
  }
));
