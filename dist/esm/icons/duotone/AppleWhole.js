...
const AppleWholeDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M320.004 0V32C320.004 76.184 284.186 112 240.001 112H208V80C208 35.816 243.821 0 288.003 0H320.004Z" })
    ]
  }
));
