...
const CarrotDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M511.634 152.002C470.005 202.254 404.125 204.504 359.746 159.877L351.746 151.877C307.115 107.502 309.367 41.75 359.621 0C399.375 32.875 409.375 81.002 389.873 121.752C430.626 102.252 478.755 112.252 511.634 152.002Z" })
    ]
  }
));
