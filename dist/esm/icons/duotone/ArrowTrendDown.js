...
const ArrowTrendDownDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M544 416H384C366.312 416 352 401.672 352 384S366.312 352 384 352H512V224C512 206.328 526.312 192 544 192S576 206.328 576 224V384C576 401.672 561.688 416 544 416Z" })
    ]
  }
));
...
export {
  ArrowTrendDown_default as default
};
