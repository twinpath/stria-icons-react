...
const ArrowTrendUpDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M544 320C526.312 320 512 305.672 512 288V160H384C366.312 160 352 145.672 352 128S366.312 96 384 96H544C561.688 96 576 110.328 576 128V288C576 305.672 561.688 320 544 320Z" })
    ]
  }
));
