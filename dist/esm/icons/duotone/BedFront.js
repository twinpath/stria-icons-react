...
const BedFrontDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M512 288V352H0V288C0 252.625 28.625 224 64 224H448C483.375 224 512 252.625 512 288Z", className: "stria-secondary", style: { opacity: 0.4 } }),
