...
const PianoDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M0 480V352H64V448H448V352H512V480C512 497.625 497.625 512 480 512H32C14.375 512 0 497.625 0 480Z", className: "stria-secondary", style: { opacity: 0.4 } }),
