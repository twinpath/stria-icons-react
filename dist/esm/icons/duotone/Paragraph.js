...
const ParagraphDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M384 96V448C384 465.674 369.674 480 352.002 480H351.998C334.326 480 320 465.674 320 448V96H384Z", className: "stria-secondary", style: { opacity: 0.4 } }),
