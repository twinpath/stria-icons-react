...
const FeatherPointedDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M24 512C17.844 512 11.719 509.656 7.031 504.969C-2.344 495.594 -2.344 480.406 7.031 471.031L311.031 167.031C320.406 157.656 335.594 157.656 344.969 167.031S354.344 191.594 344.969 200.969L40.969 504.969C36.281 509.656 30.156 512 24 512Z" })
    ]
  }
));
