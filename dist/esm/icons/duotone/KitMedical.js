...
const KitMedicalDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M96 480H128V32H96V480ZM448 32V480H480V32H448Z", className: "stria-secondary", style: { opacity: 0.4 } }),
