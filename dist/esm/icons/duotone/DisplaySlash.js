...
const DisplaySlashDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M615.968 512C610.811 512 605.593 510.328 601.186 506.891L9.189 42.898C-1.249 34.726 -3.061 19.633 5.126 9.195C13.251 -1.211 28.282 -3.086 38.814 5.117L630.811 469.11C641.249 477.282 643.061 492.375 634.874 502.813C630.155 508.844 623.093 512 615.968 512Z" })
    ]
  }
));
...
export {
  DisplaySlash_default as default
};
