...
const BlindsDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M512 16V48C512 56.836 504.836 64 496 64H128V226.938C146.6 233.549 160 251.131 160 272C160 298.51 138.51 320 112 320S64 298.51 64 272C64 251.131 77.4 233.549 96 226.938V64H16C7.164 64 0 56.836 0 48V16C0 7.162 7.164 0 16 0H496C504.836 0 512 7.162 512 16Z" })
    ]
  }
));
