...
const StarSharpHalfStrokeDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M288 403.951L144.301 508.443C140.909 510.91 137.235 512 133.683 512C122.324 512 112.192 500.873 116.337 488.109L171.225 319.035L27.526 214.543C13.284 204.186 20.602 181.641 38.206 181.641H215.829L270.716 12.566C273.436 4.189 280.719 0 288 0V403.951Z" })
    ]
  }
));
...
export {
  StarSharpHalfStroke_default as default
};
