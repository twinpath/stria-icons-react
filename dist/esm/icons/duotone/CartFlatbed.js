...
const CartFlatbedDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M448 32V160L400 128L352 160V32H448ZM624 384H128V64C128 28.8 99.2 0 64 0H16C7.2 0 0 7.2 0 16V48C0 56.8 7.2 64 16 64H48C56.837 64 64 71.163 64 80V432C64 440.8 71.2 448 80 448H624C632.8 448 640 440.8 640 432V400C640 391.2 632.8 384 624 384Z" })
    ]
  }
));
...
export {
  CartFlatbed_default as default
};
