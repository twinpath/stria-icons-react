...
const RubleSignDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M0 384C0 401.672 14.328 416 32 416H64V352H32C14.328 352 0 366.328 0 384ZM288 352H144V416H288C305.672 416 320 401.672 320 384S305.672 352 288 352Z", className: "stria-secondary", style: { opacity: 0.4 } }),
