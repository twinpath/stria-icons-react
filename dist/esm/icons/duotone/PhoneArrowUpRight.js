...
const PhoneArrowUpRightDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M297.375 169.375L402.75 64H384C366.328 64 352 49.672 352 32S366.328 0 384 0H480C497.672 0 512 14.328 512 32V128C512 145.672 497.672 160 480 160S448 145.672 448 128V109.25L342.625 214.625C330.125 227.125 309.875 227.125 297.375 214.625S284.875 181.875 297.375 169.375Z" })
    ]
  }
));
...
export {
  PhoneArrowUpRight_default as default
};
