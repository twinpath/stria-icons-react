...
const TrashClockDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M331.002 512H101.094C76.219 512 54.75 491.844 53.188 467L32 96H416L410.434 193.453C323.428 204.105 256 278.113 256 368C256 427.586 285.691 480.158 331.002 512Z", className: "stria-secondary", style: { opacity: 0.4 } }),
