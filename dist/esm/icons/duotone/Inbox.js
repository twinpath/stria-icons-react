...
const InboxDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M439.051 288H384.025L352.025 352H160.025L128.025 288H73L121.025 96H391.025L439.051 288Z", className: "stria-secondary", style: { opacity: 0.4 } }),
