...
const BatterySlashDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M24.032 0.032C29.189 0.032 34.407 1.703 38.813 5.141L630.81 469.134C641.248 477.305 643.06 492.399 634.873 502.836C626.748 513.242 611.685 515.117 601.186 506.914L9.189 42.922C-1.249 34.75 -3.061 19.656 5.126 9.219C9.845 3.188 16.907 0.032 24.032 0.032Z" })
    ]
  }
));
...
export {
  BatterySlash_default as default
};
