...
const ComputerClassicDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M384 224C384 241.625 369.625 256 352 256H96C78.375 256 64 241.625 64 224V96C64 78.375 78.375 64 96 64H352C369.625 64 384 78.375 384 96V224Z" })
    ]
  }
));
...
export {
  ComputerClassic_default as default
};
