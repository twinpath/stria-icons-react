...
const LightSwitchOnDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M240 96H144C117.6 96 96 117.6 96 144V256H288V144C288 117.6 266.4 96 240 96Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
export {
  LightSwitchOn_default as default
};
