...
const FlowerDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M256 336C211.875 336 176 300.125 176 256S211.875 176 256 176S336 211.875 336 256S300.125 336 256 336Z" })
    ]
  }
));
