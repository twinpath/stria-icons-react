...
const HandHoldingBoxDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M128 256H448C465.6 256 480 241.6 480 224V32C480 14.4 465.6 0 448 0H352V128L288 96L224 128V0H128C110.4 0 96 14.4 96 32V224C96 241.6 110.4 256 128 256Z" })
    ]
  }
));
...
export {
  HandHoldingBox_default as default
};
