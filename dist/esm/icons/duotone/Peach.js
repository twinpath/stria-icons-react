...
const PeachDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M146.637 81.814C167.703 79.24 207.115 76.986 251.396 95.703C282.857 87.395 314.648 75.615 365.365 81.813C386.262 67.379 400 43.316 400 16V0H336C291.816 0 256 35.816 256 80C256 35.816 204.184 0 160 0H112V16C112 43.318 125.74 67.381 146.637 81.814Z" })
    ]
  }
));
