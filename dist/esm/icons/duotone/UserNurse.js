...
const UserNurseDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M96 176C96 246.75 153.25 304 224 304S352 246.75 352 176V160H96V176Z ", className: "stria-secondary", style: { opacity: 0.4 } }),
