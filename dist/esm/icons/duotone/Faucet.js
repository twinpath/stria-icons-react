...
const FaucetDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M384 112V140.799C384 153.6 374.4 160 364.801 160L224 144L83.199 160C73.6 160 64 153.6 64 144V112C64 102.4 73.6 96 83.199 96L224 112L364.801 96C374.4 96 384 102.4 384 112Z" })
    ]
  }
));
