...
const AirConditionerDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M528 0H48C21.6 0 0 21.6 0 48V176C0 202.4 21.6 224 48 224H528C554.4 224 576 202.4 576 176V48C576 21.6 554.4 0 528 0ZM512 160H64V128H512V160Z" })
    ]
  }
));
