...
const BlockQuoteDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M32 208C14.326 208 0 222.326 0 240V432C0 449.674 14.326 464 32 464S64 449.674 64 432V240C64 222.326 49.674 208 32 208Z" })
    ]
  }
));
