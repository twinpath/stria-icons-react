...
const MercuryDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M256 224C256 259.346 227.346 288 192 288S128 259.346 128 224S156.654 160 192 160S256 188.654 256 224Z", className: "stria-secondary", style: { opacity: 0.4 } }),
