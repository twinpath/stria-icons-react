...
const BookOpenCoverDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M64 32.404V356.38L304 416V40.02L100.895 0.388C81.502 -2.649 64 12.537 64 32.404ZM539.105 0.388L336 40.02V416L576 356.38V32.404C576 12.537 558.498 -2.649 539.105 0.388Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
export {
  BookOpenCover_default as default
};
