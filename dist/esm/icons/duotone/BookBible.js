...
const BookBibleDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
...
BookBibleDuotone.displayName = "BookBibleDuotone";
var BookBible_default = BookBibleDuotone;
export {
