...
const CartFlatbedSuitcaseDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M512 96H480V320H512V96ZM288 96H256V320H288V96ZM624 384H128V16C128 7.25 120.75 0 112 0H16C7.25 0 0 7.25 0 16V48C0 56.75 7.25 64 16 64H64V432C64 440.75 71.25 448 80 448H624C632.75 448 640 440.75 640 432V400C640 391.25 632.75 384 624 384Z" })
    ]
  }
));
...
export {
  CartFlatbedSuitcase_default as default
};
