...
const SwordLaserDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M505.494 40.268L263.01 303.889L208 248.879L471.621 6.395C480.996 -2.355 495.744 -2.105 504.869 7.02C513.994 16.143 514.244 30.893 505.494 40.268Z", className: "stria-secondary", style: { opacity: 0.4 } }),
