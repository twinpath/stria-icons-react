...
const HomeSimpleDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M511.968 270.531V448C511.968 483.346 483.315 512 447.969 512H128C92.654 512 64 483.346 64 448V270.516L287.975 74.541L511.968 270.531Z ", className: "stria-secondary", style: { opacity: 0.4 } }),
