...
const BroomDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M628.031 57.242L402.816 232.43L363 182.293L588.719 6.715C602.719 -4.113 622.781 -1.566 633.625 12.338C644.5 26.275 641.969 46.383 628.031 57.242Z", className: "stria-secondary", style: { opacity: 0.4 } }),
