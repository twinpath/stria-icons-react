...
const OtterDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M638.016 112C630.363 157.363 591.165 192 543.628 192H520.752L428.251 241.75L393 171.25L511.627 112H638.016Z", className: "stria-secondary", style: { opacity: 0.4 } }),
