...
const DiagramLeanCanvasDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M64 320H128V96H64V320ZM512 96V320H576V96H512Z", className: "stria-secondary", style: { opacity: 0.4 } }),
