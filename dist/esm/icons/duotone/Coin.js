...
const CoinDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M512 208C512 287.5 397.375 352 256 352S0 287.5 0 208S114.625 64 256 64S512 128.5 512 208Z", className: "stria-secondary", style: { opacity: 0.4 } }),
