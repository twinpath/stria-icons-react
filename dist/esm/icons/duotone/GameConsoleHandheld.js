...
const GameConsoleHandheldDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M288 80V192C288 209.625 273.625 224 256 224H112C103.125 224 96 216.875 96 208V80C96 71.125 103.125 64 112 64H272C280.875 64 288 71.125 288 80Z" })
    ]
  }
));
