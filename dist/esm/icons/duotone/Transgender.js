...
const TransgenderDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M256 176C229.491 176 208 197.489 208 224C208 250.509 229.491 272 256 272S304 250.509 304 224C304 197.489 282.509 176 256 176Z", className: "stria-secondary", style: { opacity: 0.4 } }),
