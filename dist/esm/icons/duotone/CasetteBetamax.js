...
const CasetteBetamaxDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M0 160V432C0 458.51 21.49 480 48 480H528C554.51 480 576 458.51 576 432V160H0ZM160 416C107.051 416 64 372.949 64 320S107.051 224 160 224C212.951 224 256 267.051 256 320S212.951 416 160 416ZM512 416H320V224H512V416Z", className: "stria-secondary", style: { opacity: 0.4 } }),
