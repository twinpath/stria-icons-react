...
const LitecoinSignDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M383.996 440C383.996 462.092 366.088 480 343.996 480H104C81.908 480 64 462.092 64 440V72C64 49.906 81.906 32 104 32C126.092 32 143.998 49.906 143.998 72V400H343.996C366.088 400 383.996 417.908 383.996 440Z" })
    ]
  }
));
