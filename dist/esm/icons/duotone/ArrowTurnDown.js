...
const ArrowTurnDownDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M192.002 417.289L152 379.945V80H40C17.906 80 0 62.094 0 40S17.906 0 40 0L192 0C214.094 0 232 17.906 232 40V379.953L192.002 417.289Z", className: "stria-secondary", style: { opacity: 0.4 } }),
