...
const DiagramProjectDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M144.25 192H128L224.883 361.771C227.988 338.314 247.98 320 272.25 320H274.699L186.646 165.971C178.621 181.334 162.701 192 144.25 192ZM192.25 64V128H448.25V64H192.25Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
export {
  DiagramProject_default as default
};
