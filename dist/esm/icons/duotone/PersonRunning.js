...
const PersonRunningDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M288 96C314.5 96 336 74.5 336 48S314.5 0 288 0S240 21.5 240 48S261.5 96 288 96Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
export {
  PersonRunning_default as default
};
