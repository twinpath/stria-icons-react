...
const BookOpenReaderDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M352 96C352 43 309 0 256 0S160 43 160 96S203 192 256 192S352 149 352 96Z", className: "stria-secondary", style: { opacity: 0.4 } }),
