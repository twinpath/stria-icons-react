...
const FiltersDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M611.387 32H220.613C196.561 32 183.281 59.365 198.453 77.662L352 262.822V368C352 375.828 355.813 383.172 362.25 387.656L442.25 443.641C458.031 454.688 480 443.5 480 423.984V262.822L633.547 77.662C648.719 59.365 635.438 32 611.387 32Z" })
    ]
  }
));
