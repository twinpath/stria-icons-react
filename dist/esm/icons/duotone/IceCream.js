...
const IceCreamDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M368.832 256L253.041 493.749C247.916 504.874 236.666 511.999 224.416 511.999S200.916 504.874 195.791 493.749L80 256H368.832Z " })
    ]
  }
));
