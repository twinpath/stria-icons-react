...
const LessThanEqualDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M0 439.998V440C0 462.092 17.902 480 39.984 480H408.016C430.098 480 448 462.092 448 440S430.098 400 408.016 400H39.984C17.902 400 0 417.908 0 439.998Z", className: "stria-secondary", style: { opacity: 0.4 } }),
