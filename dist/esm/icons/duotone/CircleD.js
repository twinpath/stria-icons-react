...
const CircleDDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M254.406 128H184C170.75 128 160 138.75 160 152V360C160 373.25 170.75 384 184 384H254.406C325.859 384 384 326.594 384 256C384 185.422 325.859 128 254.406 128ZM254.406 336H208V176H254.406C299.391 176 336 211.891 336 256C336 300.125 299.391 336 254.406 336Z" })
    ]
  }
));
