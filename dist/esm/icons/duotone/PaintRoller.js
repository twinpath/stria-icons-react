...
const PaintRollerDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M416 32V128C416 145.656 401.656 160 384 160H32C14.344 160 0 145.656 0 128V32C0 14.344 14.344 0 32 0H384C401.656 0 416 14.344 416 32Z" })
    ]
  }
));
