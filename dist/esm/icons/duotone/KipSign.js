...
const KipSignDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M352 224H205.227L170.281 256L205.227 288H352C369.688 288 384 273.688 384 256S369.688 224 352 224ZM0 256C0 273.688 14.312 288 32 288H64V224H32C14.312 224 0 238.312 0 256Z", className: "stria-secondary", style: { opacity: 0.4 } }),
