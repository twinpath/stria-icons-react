...
const WineGlassDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M252.29 160L255.613 197.277C259.891 245.289 228.127 289.111 181.16 299.99L180.384 300.17C166.739 303.33 152.548 303.318 138.907 300.133C91.873 289.15 60.099 245.232 64.387 197.135L67.698 160H252.29Z" })
    ]
  }
));
