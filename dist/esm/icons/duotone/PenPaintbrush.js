...
const PenPaintbrushDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M370.74 60.08L58.261 372.52C53.605 377.176 50.498 383.152 49.365 389.638L32.326 487.108C29.793 501.6 42.412 514.213 56.904 511.672L154.433 494.571C160.912 493.436 166.884 490.331 171.535 485.681L483.927 173.281L370.74 60.08Z" })
    ]
  }
));
...
export {
  PenPaintbrush_default as default
};
