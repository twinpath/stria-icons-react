...
const GarageDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M128 512H512V352H128.125L128 512ZM272 416H368C376.875 416 384 423.125 384 432S376.875 448 368 448H272C263.125 448 256 440.875 256 432S263.125 416 272 416ZM128 320H511.5L512 224H128V320Z" })
    ]
  }
));
