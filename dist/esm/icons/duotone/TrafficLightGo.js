...
const TrafficLightGoDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M192 416.001C165.5 416.001 144 394.501 144 368.001S165.5 320.001 192 320.001S240 341.501 240 368.001S218.5 416.001 192 416.001Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
export {
  TrafficLightGo_default as default
};
