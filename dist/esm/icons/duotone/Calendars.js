...
const CalendarsDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M96 368C96 394.5 117.5 416 144 416H464C490.5 416 512 394.5 512 368V192H96V368Z", className: "stria-secondary", style: { opacity: 0.4 } }),
