...
const TvRetroDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M384 224V384C384 419.346 355.346 448 320 448H128C92.654 448 64 419.346 64 384V224C64 188.652 92.654 160 128 160H320C355.346 160 384 188.652 384 224Z" })
    ]
  }
));
