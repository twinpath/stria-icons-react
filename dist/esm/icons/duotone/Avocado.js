...
const AvocadoDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M319.571 264.66C319.571 325.396 260.939 383.999 200.495 383.999C145.981 383.999 128 340.414 128 311.341C128 250.588 186.637 191.999 247.073 191.999C301.588 191.999 319.571 235.586 319.571 264.66Z" })
    ]
  }
));
