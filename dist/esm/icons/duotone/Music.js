...
const MusicDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M192 224V83.691L448 8.092V148.994L192 224Z", className: "stria-secondary", style: { opacity: 0.4 } }),
