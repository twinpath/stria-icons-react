...
const CircleNotchDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M384 256.003C384 326.696 326.692 384.003 256 384.003S128 326.696 128 256.003S185.308 128.003 256 128.003S384 185.311 384 256.003Z", className: "stria-secondary", style: { opacity: 0.4 } }),
