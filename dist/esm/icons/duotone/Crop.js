...
const CropDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M0 88V136C0 149.25 10.75 160 24 160H64V64H24C10.75 64 0 74.75 0 88ZM424 64H192V160H352V488C352 501.25 362.75 512 376 512H424C437.25 512 448 501.25 448 488V88C448 74.75 437.25 64 424 64Z" })
    ]
  }
));
