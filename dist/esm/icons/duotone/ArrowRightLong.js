...
const ArrowRightLongDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M402.75 288H32C14.312 288 0 273.688 0 256S14.312 224 32 224H402.75L434.75 256L402.75 288Z", className: "stria-secondary", style: { opacity: 0.4 } }),
