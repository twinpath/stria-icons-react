...
const ChartPieSimpleDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M511.979 223.266C512.604 232.265 504.854 240.014 495.73 240.014H272V16.284C272 7.16 279.624 -0.59 288.749 0.035C408.238 8.285 503.73 103.776 511.979 223.266Z" })
    ]
  }
));
...
export {
  ChartPieSimple_default as default
};
