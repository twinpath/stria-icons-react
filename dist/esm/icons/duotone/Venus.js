...
const VenusDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M256 176C256 211.346 227.346 240 192 240S128 211.346 128 176S156.654 112 192 112S256 140.654 256 176Z", className: "stria-secondary", style: { opacity: 0.4 } }),
