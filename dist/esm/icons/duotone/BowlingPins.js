...
const BowlingPinsDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M86.465 192.039H169.672L170.137 160.043H86L86.465 192.039ZM342 160.043L342.465 192.039H425.672L426.137 160.043H342Z" })
    ]
  }
));
...
export {
  BowlingPins_default as default
};
