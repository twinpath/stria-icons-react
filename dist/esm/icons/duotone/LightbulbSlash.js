...
const LightbulbSlashDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M615.984 512C610.796 512 605.593 510.344 601.187 506.875L9.187 42.88C-1.235 34.724 -3.063 19.63 5.109 9.193C13.296 -1.213 28.343 -3.088 38.812 5.13L630.812 469.125C641.234 477.282 643.062 492.375 634.89 502.813C630.156 508.844 623.109 512 615.984 512Z" })
    ]
  }
));
...
export {
  LightbulbSlash_default as default
};
