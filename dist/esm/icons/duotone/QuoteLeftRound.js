...
const QuoteLeftRoundDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M112 256C106.002 256 100.23 256.857 94.486 257.766L96 256V192C96 156.75 124.75 128 160 128H168C181.25 128 192 117.25 192 104V56C192 42.75 181.25 32 168 32H160C71.625 32 0 103.625 0 192V368C0 429.855 50.145 480 112 480S224 429.855 224 368S173.855 256 112 256Z" })
    ]
  }
));
...
export {
  QuoteLeftRound_default as default
};
