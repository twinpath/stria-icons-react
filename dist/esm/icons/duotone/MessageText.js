...
const MessageTextDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M368 136C368 149.25 357.25 160 344 160H280V296C280 309.25 269.25 320 256 320S232 309.25 232 296V160H168C154.75 160 144 149.25 144 136S154.75 112 168 112H344C357.25 112 368 122.75 368 136Z" })
    ]
  }
));
