...
const SterlingSignDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M224 224H128V288H224C241.688 288 256 273.672 256 256S241.688 224 224 224ZM0 256C0 273.672 14.312 288 32 288H48V224H32C14.312 224 0 238.328 0 256Z", className: "stria-secondary", style: { opacity: 0.4 } }),
