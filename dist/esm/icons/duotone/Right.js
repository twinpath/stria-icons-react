...
const RightDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M224 320H32C14.326 320 0 305.672 0 288V224C0 206.326 14.326 192 32 192H224V320Z", className: "stria-secondary", style: { opacity: 0.4 } }),
