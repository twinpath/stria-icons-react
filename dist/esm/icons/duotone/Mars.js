...
const MarsDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M240 304C240 339.346 211.346 368 176 368S112 339.346 112 304S140.654 240 176 240S240 268.654 240 304Z", className: "stria-secondary", style: { opacity: 0.4 } }),
