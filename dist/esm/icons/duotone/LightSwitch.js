...
const LightSwitchDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M288 272H96V240H288V272Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
export {
  LightSwitch_default as default
};
