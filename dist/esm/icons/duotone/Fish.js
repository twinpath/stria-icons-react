...
const FishDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M416 288C398.334 288 384 273.664 384 256C384 238.332 398.334 224 416 224S448 238.332 448 256C448 273.664 433.666 288 416 288Z" })
    ]
  }
));
