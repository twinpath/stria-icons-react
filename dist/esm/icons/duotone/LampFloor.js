...
const LampFloorDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M224.006 448H160V224H224.006V448Z", className: "stria-secondary", style: { opacity: 0.4 } }),
