...
const MarsStrokeDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M272 304C272 339.346 243.346 368 208 368S144 339.346 144 304S172.654 240 208 240S272 268.654 272 304Z", className: "stria-secondary", style: { opacity: 0.4 } }),
