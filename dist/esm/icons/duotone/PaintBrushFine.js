...
const PaintBrushFineDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M559.875 16.406C538 -5.469 502.563 -5.469 480.688 16.406L228 269.094L307.188 348.281L559.875 95.594C581.75 73.719 581.75 38.281 559.875 16.406Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
export {
  PaintBrushFine_default as default
};
