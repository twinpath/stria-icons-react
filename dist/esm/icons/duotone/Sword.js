...
const SwordDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M511.598 18.285L495.725 112.029L244.992 362.76L149 266.768L399.73 16.035L493.475 0.162C503.973 -1.338 513.098 7.787 511.598 18.285Z", className: "stria-secondary", style: { opacity: 0.4 } }),
