...
const RotateForwardDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M495.986 59.035V204.93C495.986 215.52 487.402 224.103 476.812 224.103H331.065C307.005 224.103 294.952 195.02 311.959 178.002L449.916 39.961C466.913 22.955 495.986 34.99 495.986 59.035Z" })
    ]
  }
));
