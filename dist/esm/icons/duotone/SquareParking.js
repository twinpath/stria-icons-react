...
const SquareParkingDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M240 128H160C142.312 128 128 142.312 128 160V352C128 369.688 142.312 384 160 384S192 369.688 192 352V320H240C292.938 320 336 276.938 336 224S292.938 128 240 128ZM240 256H192V192H240C257.656 192 272 206.344 272 224S257.656 256 240 256Z" })
    ]
  }
));
