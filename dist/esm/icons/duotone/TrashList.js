...
const TrashListDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M53.188 467C54.75 491.844 76.219 512 101.094 512H314.906C339.781 512 361.25 491.844 362.812 467L384 96H32L53.188 467Z", className: "stria-secondary", style: { opacity: 0.4 } }),
