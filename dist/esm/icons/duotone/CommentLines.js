...
const CommentLinesDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M264 272H152C138.75 272 128 282.75 128 296S138.75 320 152 320H264C277.25 320 288 309.25 288 296S277.25 272 264 272ZM360 176H152C138.75 176 128 186.75 128 200S138.75 224 152 224H360C373.25 224 384 213.25 384 200S373.25 176 360 176Z" })
    ]
  }
));
...
export {
  CommentLines_default as default
};
