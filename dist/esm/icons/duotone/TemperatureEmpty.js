...
const TemperatureEmptyDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M160 320.001C133.49 320.001 112 341.491 112 368.001S133.49 416.001 160 416.001S208 394.51 208 368.001S186.51 320.001 160 320.001Z" })
    ]
  }
));
