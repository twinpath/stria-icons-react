...
const FloppyDiskCircleArrowRightDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
...
export {
  FloppyDiskCircleArrowRight_default as default
};
