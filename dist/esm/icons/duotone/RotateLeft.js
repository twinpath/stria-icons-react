...
const RotateLeftDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M62.07 39.962L200.028 178.003C217.034 195.02 204.981 224.104 180.921 224.104H35.175C24.584 224.104 16 215.52 16 204.93V59.036C16 34.991 45.074 22.956 62.07 39.962Z" })
    ]
  }
));
