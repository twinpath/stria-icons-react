...
const ScalpelLineDashedDuotone = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ref,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M288 320V328C288 366.375 272.277 404.625 240.191 430.375C239.936 430.5 239.809 430.625 239.553 430.875C174.104 482.875 88.969 512.125 0 512L179.984 320H288Z", className: "stria-secondary", style: { opacity: 0.4 } }),
...
export {
  ScalpelLineDashed_default as default
};
