...
const CircleQuestionRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleQuestionRegular.displayName = "CircleQuestionRegular";
var CircleQuestion_default = CircleQuestionRegular;
export {
