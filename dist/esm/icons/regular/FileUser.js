...
const FileUserRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
FileUserRegular.displayName = "FileUserRegular";
var FileUser_default = FileUserRegular;
export {
