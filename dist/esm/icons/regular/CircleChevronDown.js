...
const CircleChevronDownRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleChevronDownRegular.displayName = "CircleChevronDownRegular";
var CircleChevronDown_default = CircleChevronDownRegular;
export {
