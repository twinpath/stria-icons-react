...
const OctagonPlusRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
OctagonPlusRegular.displayName = "OctagonPlusRegular";
var OctagonPlus_default = OctagonPlusRegular;
export {
  OctagonPlus_default as default
};
