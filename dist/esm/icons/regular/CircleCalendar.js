...
const CircleCalendarRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleCalendarRegular.displayName = "CircleCalendarRegular";
var CircleCalendar_default = CircleCalendarRegular;
export {
