...
const CircleLocationArrowRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleLocationArrowRegular.displayName = "CircleLocationArrowRegular";
var CircleLocationArrow_default = CircleLocationArrowRegular;
export {
