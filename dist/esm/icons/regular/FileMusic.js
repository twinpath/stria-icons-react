...
const FileMusicRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
FileMusicRegular.displayName = "FileMusicRegular";
var FileMusic_default = FileMusicRegular;
export {
  FileMusic_default as default
};
