...
const BookCircleArrowUpRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
BookCircleArrowUpRegular.displayName = "BookCircleArrowUpRegular";
var BookCircleArrowUp_default = BookCircleArrowUpRegular;
export {
