...
const CircleZRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleZRegular.displayName = "CircleZRegular";
var CircleZ_default = CircleZRegular;
export {
