...
const SquareZRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
SquareZRegular.displayName = "SquareZRegular";
var SquareZ_default = SquareZRegular;
export {
