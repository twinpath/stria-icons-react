...
const CircleVideoRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleVideoRegular.displayName = "CircleVideoRegular";
var CircleVideo_default = CircleVideoRegular;
export {
