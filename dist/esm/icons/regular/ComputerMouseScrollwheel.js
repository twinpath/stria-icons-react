...
const ComputerMouseScrollwheelRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
ComputerMouseScrollwheelRegular.displayName = "ComputerMouseScrollwheelRegular";
var ComputerMouseScrollwheel_default = ComputerMouseScrollwheelRegular;
export {
