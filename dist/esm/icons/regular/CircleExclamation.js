...
const CircleExclamationRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleExclamationRegular.displayName = "CircleExclamationRegular";
var CircleExclamation_default = CircleExclamationRegular;
export {
  CircleExclamation_default as default
};
