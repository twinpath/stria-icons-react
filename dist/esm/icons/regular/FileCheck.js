...
const FileCheckRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
FileCheckRegular.displayName = "FileCheckRegular";
var FileCheck_default = FileCheckRegular;
export {
