...
const FileZipperRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
FileZipperRegular.displayName = "FileZipperRegular";
var FileZipper_default = FileZipperRegular;
export {
  FileZipper_default as default
};
