...
const FilePlusMinusRegular = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
FilePlusMinusRegular.displayName = "FilePlusMinusRegular";
var FilePlusMinus_default = FilePlusMinusRegular;
export {
