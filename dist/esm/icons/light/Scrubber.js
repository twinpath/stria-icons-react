...
const ScrubberLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
ScrubberLight.displayName = "ScrubberLight";
var Scrubber_default = ScrubberLight;
export {
