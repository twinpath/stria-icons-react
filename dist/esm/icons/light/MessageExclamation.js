...
const MessageExclamationLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
MessageExclamationLight.displayName = "MessageExclamationLight";
var MessageExclamation_default = MessageExclamationLight;
export {
