...
const MessageMedicalLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
MessageMedicalLight.displayName = "MessageMedicalLight";
var MessageMedical_default = MessageMedicalLight;
export {
