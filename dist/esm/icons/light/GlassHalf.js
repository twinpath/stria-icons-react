...
const GlassHalfLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
GlassHalfLight.displayName = "GlassHalfLight";
var GlassHalf_default = GlassHalfLight;
export {
