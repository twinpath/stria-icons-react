...
const SquareArrowUpLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
SquareArrowUpLight.displayName = "SquareArrowUpLight";
var SquareArrowUp_default = SquareArrowUpLight;
export {
