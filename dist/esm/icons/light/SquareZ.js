...
const SquareZLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
SquareZLight.displayName = "SquareZLight";
var SquareZ_default = SquareZLight;
export {
