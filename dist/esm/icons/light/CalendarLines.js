...
const CalendarLinesLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CalendarLinesLight.displayName = "CalendarLinesLight";
var CalendarLines_default = CalendarLinesLight;
export {
