...
const LocationDotLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
LocationDotLight.displayName = "LocationDotLight";
var LocationDot_default = LocationDotLight;
export {
