...
const CircleInfoLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleInfoLight.displayName = "CircleInfoLight";
var CircleInfo_default = CircleInfoLight;
export {
