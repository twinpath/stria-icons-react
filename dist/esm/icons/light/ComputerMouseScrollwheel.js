...
const ComputerMouseScrollwheelLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
ComputerMouseScrollwheelLight.displayName = "ComputerMouseScrollwheelLight";
var ComputerMouseScrollwheel_default = ComputerMouseScrollwheelLight;
export {
