...
const FilmSimpleLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
FilmSimpleLight.displayName = "FilmSimpleLight";
var FilmSimple_default = FilmSimpleLight;
export {
