...
const CircleEnvelopeLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleEnvelopeLight.displayName = "CircleEnvelopeLight";
var CircleEnvelope_default = CircleEnvelopeLight;
export {
