...
const BarsStaggeredLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
BarsStaggeredLight.displayName = "BarsStaggeredLight";
var BarsStaggered_default = BarsStaggeredLight;
export {
