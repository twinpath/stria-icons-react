...
const CirclePauseLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CirclePauseLight.displayName = "CirclePauseLight";
var CirclePause_default = CirclePauseLight;
export {
