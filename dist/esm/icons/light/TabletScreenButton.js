...
const TabletScreenButtonLight = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
TabletScreenButtonLight.displayName = "TabletScreenButtonLight";
var TabletScreenButton_default = TabletScreenButtonLight;
export {
