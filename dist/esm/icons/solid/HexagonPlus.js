...
const HexagonPlusSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
HexagonPlusSolid.displayName = "HexagonPlusSolid";
var HexagonPlus_default = HexagonPlusSolid;
export {
