...
const CircleRightSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleRightSolid.displayName = "CircleRightSolid";
var CircleRight_default = CircleRightSolid;
export {
