...
const Circle7Solid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
Circle7Solid.displayName = "Circle7Solid";
var Circle7_default = Circle7Solid;
export {
