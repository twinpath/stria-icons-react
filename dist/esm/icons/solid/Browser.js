...
const BrowserSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
BrowserSolid.displayName = "BrowserSolid";
var Browser_default = BrowserSolid;
export {
