...
const UserMinusSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
UserMinusSolid.displayName = "UserMinusSolid";
var UserMinus_default = UserMinusSolid;
export {
