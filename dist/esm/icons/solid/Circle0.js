...
const Circle0Solid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
Circle0Solid.displayName = "Circle0Solid";
var Circle0_default = Circle0Solid;
export {
