...
const CircleWaveformLinesSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleWaveformLinesSolid.displayName = "CircleWaveformLinesSolid";
var CircleWaveformLines_default = CircleWaveformLinesSolid;
export {
  CircleWaveformLines_default as default
};
