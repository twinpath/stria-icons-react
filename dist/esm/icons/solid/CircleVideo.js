...
const CircleVideoSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleVideoSolid.displayName = "CircleVideoSolid";
var CircleVideo_default = CircleVideoSolid;
export {
