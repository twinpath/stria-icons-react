...
const BookCircleArrowUpSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
BookCircleArrowUpSolid.displayName = "BookCircleArrowUpSolid";
var BookCircleArrowUp_default = BookCircleArrowUpSolid;
export {
