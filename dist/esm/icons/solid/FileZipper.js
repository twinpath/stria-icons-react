...
const FileZipperSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
FileZipperSolid.displayName = "FileZipperSolid";
var FileZipper_default = FileZipperSolid;
export {
