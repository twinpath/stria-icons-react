...
const CircleArrowDownLeftSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleArrowDownLeftSolid.displayName = "CircleArrowDownLeftSolid";
var CircleArrowDownLeft_default = CircleArrowDownLeftSolid;
export {
