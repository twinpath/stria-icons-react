...
const CircleCaretUpSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleCaretUpSolid.displayName = "CircleCaretUpSolid";
var CircleCaretUp_default = CircleCaretUpSolid;
export {
