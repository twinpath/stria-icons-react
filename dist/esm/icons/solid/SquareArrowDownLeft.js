...
const SquareArrowDownLeftSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
SquareArrowDownLeftSolid.displayName = "SquareArrowDownLeftSolid";
var SquareArrowDownLeft_default = SquareArrowDownLeftSolid;
export {
