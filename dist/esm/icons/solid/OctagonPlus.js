...
const OctagonPlusSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
OctagonPlusSolid.displayName = "OctagonPlusSolid";
var OctagonPlus_default = OctagonPlusSolid;
export {
