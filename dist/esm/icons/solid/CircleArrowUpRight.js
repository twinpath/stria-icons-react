...
const CircleArrowUpRightSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleArrowUpRightSolid.displayName = "CircleArrowUpRightSolid";
var CircleArrowUpRight_default = CircleArrowUpRightSolid;
export {
