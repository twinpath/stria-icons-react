...
const CommentArrowUpRightSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CommentArrowUpRightSolid.displayName = "CommentArrowUpRightSolid";
var CommentArrowUpRight_default = CommentArrowUpRightSolid;
export {
