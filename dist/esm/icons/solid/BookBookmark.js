...
const BookBookmarkSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
BookBookmarkSolid.displayName = "BookBookmarkSolid";
var BookBookmark_default = BookBookmarkSolid;
export {
