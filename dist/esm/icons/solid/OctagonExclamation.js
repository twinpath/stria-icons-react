...
const OctagonExclamationSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
OctagonExclamationSolid.displayName = "OctagonExclamationSolid";
var OctagonExclamation_default = OctagonExclamationSolid;
export {
  OctagonExclamation_default as default
};
