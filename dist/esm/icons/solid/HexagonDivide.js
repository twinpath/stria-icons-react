...
const HexagonDivideSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
HexagonDivideSolid.displayName = "HexagonDivideSolid";
var HexagonDivide_default = HexagonDivideSolid;
export {
  HexagonDivide_default as default
};
