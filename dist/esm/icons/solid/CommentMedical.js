...
const CommentMedicalSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CommentMedicalSolid.displayName = "CommentMedicalSolid";
var CommentMedical_default = CommentMedicalSolid;
export {
