...
const CommentMinusSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CommentMinusSolid.displayName = "CommentMinusSolid";
var CommentMinus_default = CommentMinusSolid;
export {
