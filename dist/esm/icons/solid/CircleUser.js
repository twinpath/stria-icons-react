...
const CircleUserSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleUserSolid.displayName = "CircleUserSolid";
var CircleUser_default = CircleUserSolid;
export {
  CircleUser_default as default
};
