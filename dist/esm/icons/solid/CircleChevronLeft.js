...
const CircleChevronLeftSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleChevronLeftSolid.displayName = "CircleChevronLeftSolid";
var CircleChevronLeft_default = CircleChevronLeftSolid;
export {
