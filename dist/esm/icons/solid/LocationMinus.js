...
const LocationMinusSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
LocationMinusSolid.displayName = "LocationMinusSolid";
var LocationMinus_default = LocationMinusSolid;
export {
