...
const CircleUSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleUSolid.displayName = "CircleUSolid";
var CircleU_default = CircleUSolid;
export {
