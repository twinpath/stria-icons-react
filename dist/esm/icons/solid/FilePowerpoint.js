...
const FilePowerpointSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
FilePowerpointSolid.displayName = "FilePowerpointSolid";
var FilePowerpoint_default = FilePowerpointSolid;
export {
