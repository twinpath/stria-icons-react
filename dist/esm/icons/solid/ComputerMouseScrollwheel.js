...
const ComputerMouseScrollwheelSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
ComputerMouseScrollwheelSolid.displayName = "ComputerMouseScrollwheelSolid";
var ComputerMouseScrollwheel_default = ComputerMouseScrollwheelSolid;
export {
