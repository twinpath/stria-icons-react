...
const OctagonSolid = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
OctagonSolid.displayName = "OctagonSolid";
var Octagon_default = OctagonSolid;
export {
