...
const FacebookFBrands = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
FacebookFBrands.displayName = "FacebookFBrands";
var FacebookF_default = FacebookFBrands;
export {
  FacebookF_default as default
};
