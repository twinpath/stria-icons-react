...
const AppleBrands = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
AppleBrands.displayName = "AppleBrands";
var Apple_default = AppleBrands;
export {
