...
const CircleStopThin = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleStopThin.displayName = "CircleStopThin";
var CircleStop_default = CircleStopThin;
export {
