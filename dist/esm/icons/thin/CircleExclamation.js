...
const CircleExclamationThin = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleExclamationThin.displayName = "CircleExclamationThin";
var CircleExclamation_default = CircleExclamationThin;
export {
