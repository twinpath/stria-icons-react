...
const TableLayoutThin = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
TableLayoutThin.displayName = "TableLayoutThin";
var TableLayout_default = TableLayoutThin;
export {
