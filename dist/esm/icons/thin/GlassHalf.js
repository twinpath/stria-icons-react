...
const GlassHalfThin = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
GlassHalfThin.displayName = "GlassHalfThin";
var GlassHalf_default = GlassHalfThin;
export {
