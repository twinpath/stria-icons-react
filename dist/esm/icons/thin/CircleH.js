...
const CircleHThin = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleHThin.displayName = "CircleHThin";
var CircleH_default = CircleHThin;
export {
