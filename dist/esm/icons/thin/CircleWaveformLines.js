...
const CircleWaveformLinesThin = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
CircleWaveformLinesThin.displayName = "CircleWaveformLinesThin";
var CircleWaveformLines_default = CircleWaveformLinesThin;
export {
