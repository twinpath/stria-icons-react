...
const FolderArrowUpThin = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
FolderArrowUpThin.displayName = "FolderArrowUpThin";
var FolderArrowUp_default = FolderArrowUpThin;
export {
