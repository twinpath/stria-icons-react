...
const RectangleXmarkThin = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
RectangleXmarkThin.displayName = "RectangleXmarkThin";
var RectangleXmark_default = RectangleXmarkThin;
export {
