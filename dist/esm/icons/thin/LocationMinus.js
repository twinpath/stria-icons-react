...
const LocationMinusThin = forwardRef(({ size = 24, color = "currentColor", className, ...props }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ref,
...
LocationMinusThin.displayName = "LocationMinusThin";
var LocationMinus_default = LocationMinusThin;
export {
